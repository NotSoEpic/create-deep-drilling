...
public class ModuleRenderer<T extends BaseModuleBlockEntity> extends KineticBlockEntityRenderer<T> {
	...
	protected SuperByteBuffer getRotatedModel(T be, BlockState state) {
		return CachedBufferer.partialFacing(DDPartialModels.MODULE_SHAFT, state);
	}
}
